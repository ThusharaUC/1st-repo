...
<section class="internal-header overlay-dark" data-stellar-background-ratio="0.5">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h2 class="title">CLIENT MESSAGES</h2>
                <ol class="breadcrumb">
    ...
    <div id="layout">
        ...
        if((isset($_POST['delete'])) && (isset($_POST['checkbox']))){
            for($i=0; $i<count($_POST['checkbox']); $i++){
                ...
                $delete = $db->query("DELETE FROM feedback WHERE id='$del_id'");
                if (!$delete->error()) {
                    echo '<script>
                    ...
                    <table class="table table_striped" id="table">
                        ...
                        for($i=0; $i<$count; $i++){
                            ...
                            echo
                                "<tr>
                                                <td>&nbsp;{$j}</td>
                                                <td>&nbsp;{$db_result[$i]->name}</td>
                                                <td>&nbsp;{$db_result[$i]->email}</td>
                                                <td>&nbsp;{$db_result[$i]->mobile}</td>
